...
export type InjectedWalletProvider<P> = Provider &
  P & {
    isConnected?: () => boolean;
    providers?: InjectedWalletProvider<P>[];
    get chainId(): string;
    get accounts(): string[];
  };
...
export class NoError extends Error {
  public constructor() {
    super("wallet not installed");
    this.name = NoError.name;
    Object.setPrototypeOf(this, NoError.prototype);
  }
}
 ...
 */
export interface InjectedConstructorArgs<P = {}> {
  actions: Actions;
  getProvider: () => Promise<InjectedWalletProvider<P>> | InjectedWalletProvider<P>;
  onError?: (error: Error) => void;
}

export class InjectedWallet<P> extends Connector {
  /** {@inheritdoc Connector.provider} */
  public provider?: InjectedWalletProvider<P>;
  public getProvider: () => Promise<InjectedWalletProvider<P>> | InjectedWalletProvider<P>;
  private eagerConnection?: boolean;

  constructor({ actions, getProvider, onError }: InjectedConstructorArgs<P>) {
  ...
  public async activate(desiredChainIdOrChainParameters?: number | AddEthereumChainParameter): Promise<void> {
    ...
    return this.isomorphicInitialize()
      .then(async () => {
        if (!this.provider) throw new NoError();
